...
protected:
  ...
  AnalysisTree::Matching *rec2sim_match_{nullptr};
  AnalysisTree::Matching *rec2tof_match_{nullptr};
  ...
  int gauss_pid_id_vtx_{AnalysisTree::UndefValueInt};
  ...
  int gauss_pid_id_w1_{AnalysisTree::UndefValueInt};
